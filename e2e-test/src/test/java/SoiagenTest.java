...
public class SoiagenTest {
    ...
    public void testStructBuilderUpdate() {
      ...
      final Triangle triangle = Triangle.partialBuilder().setColor(red).build().toBuilder().updateColor(
          color -> color.toBuilder().setB(255).build()
      ).build();
    ...
    public void testRecursiveStruct() {
      final RecA recA = RecA.partialBuilder()
          .setA(RecA.partialBuilder().setB(RecB.partialBuilder().setA(RecA.partialBuilder().setBool(true).build()).build()).build()).build();
    ...
    public void testEnumKind() {
        Assertions.assertEquals(JsonValue.Kind.ARRAY_WRAPPER, JsonValue.wrapArray(new ArrayList<>()).kind());
    ...
    public void testEnumVisitor() {
      ...
      Assertions.assertEquals("hi array of size 0", JsonValue.wrapArray(new ArrayList<>()).accept(visitor));
